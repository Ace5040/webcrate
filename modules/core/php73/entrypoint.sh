...
cp /webcrate/pools/$WEBCRATE_PROJECT.conf /etc/php/7.3/fpm/pool.d/$WEBCRATE_PROJECT.conf
sed -i "s/error_log = \/var\/log\/php7.3-fpm.log/error_log = \/home\/$WEBCRATE_PROJECT\/log\/php-fpm-error.log/g" /etc/php/7.3/fpm/php-fpm.conf
