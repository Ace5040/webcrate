...
log.write(f'{PROJECT_NAME} - run project config')
os.system(f'docker exec webcrate-utils-docker /project-config.py {PROJECT_NAME} reload')
log.write(f'{PROJECT_NAME} - project config done')
log.write(f'{PROJECT_NAME} - run project start')
os.system(f'docker exec webcrate-utils-docker /project-start.py {PROJECT_NAME} reload')
log.write(f'{PROJECT_NAME} - run project started')
