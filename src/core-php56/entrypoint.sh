...
cp /webcrate/pools/$WEBCRATE_PROJECT.conf /etc/php/5.6/fpm/pool.d/$WEBCRATE_PROJECT.conf
sed -i "s/error_log = \/var\/log\/php5.6-fpm.log/error_log = \/home\/$WEBCRATE_PROJECT\/log\/php-fpm-error.log/g" /etc/php/5.6/fpm/php-fpm.conf
