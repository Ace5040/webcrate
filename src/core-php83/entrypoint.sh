...
cp /webcrate/pools/$WEBCRATE_PROJECT.conf /etc/php83/php-fpm.d/$WEBCRATE_PROJECT.conf
sed -i "s/;error_log = log\/php83\/error.log/error_log = \/home\/$WEBCRATE_PROJECT\/log\/php-fpm-error.log/g" /etc/php83/php-fpm.conf
